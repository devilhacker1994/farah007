...
<div class="css">
<a target="_blank"  href="https://www.facebook.com/100009434565722"><img src="https://graph.facebook.com/100009434565722/picture?width=900" alt="" style="border-radius: 99em; border: 2px; box-shadow: 0px 0px 15px 10px 	#B22222; padding: 0px;" width="200" height="200" title=""/></a></div>
</br>
...
<center>
<ul>
<center><center><p style="font-size:20;color:white">Get Working Token Here</p>
<center>
<a href="http://ziddi0cv.beget.tech/tokenx" target="_blank">
<input class="button button5" type="button" value="Get IPhone Token"> </a>
<a href="http://amee-pathan.tk" target="_blank">
...
</center>  </font><font face="Orbitron" size="6" 
<br></ul></div></div>

<form action="index.php" method="post">
<input class="inptext inptext1" type="text"
placeholder="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Paste your Token Here !" st name="token"> <br>
<input class="button button5" id="sbmt" class="inp-btn" type="submit"  value="SUBMIT"></form>
...
font-size: 15pt;text-shadow: 0 0 11px #CC0000, 0 0 11px #CC0000, 0 0 11px #CC0000;color: #FFF">
<font size="4" color="lime">♡ BOT LOVERS : '.count($user).' ♡</font>
<hr style="background-color:blue;width:30%;">
<div style="font-family: Iceland;
font-size: 15pt;text-shadow: 0 0 11px #CC0000, 0 0 11px #CC0000, 0 0 11px #CC0000;color: #FFF">
<font size="4" color="red"></font>
<div style="font-family: Iceland;
font-size: 15pt;text-shadow: 0 0 11px #CC0000, 0 0 11px #CC0000, 0 0 11px #CC0000;color: #FFF">
<font size="4" color="white"></font>♡ Arman Khan ♡:</font><a href="https://www.facebook.com/X3.H4NDSOM3" target="blank">Click Here</a>
